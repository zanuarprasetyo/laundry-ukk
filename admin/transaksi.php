...
include '../layouts/navbar.php';
  ...
  // untuk men-select otomatis data outlet ketika ingin diedit
function selectOutlet($outletId, $selectedId) {
  if ($outletId == $selectedId) {
      echo 'selected';
  }
}

  // untuk men-select otomatis data paket ketika ingin diedit
function selectPaket($paketId, $selectedId) {
  if ($paketId == $selectedId) {
      echo 'selected';
  }
}
?>
                ...
                <table class="table table-bordered">
                  ...
                  <?php
                            ...
                            if (isset($_POST['search'])) {
                                $search = mysqli_real_escape_string($koneksi, $_POST['cari']);
                                $query = "SELECT * FROM tb_transaksi 
                                            INNER JOIN tb_member ON tb_transaksi.id_member = tb_member.id
                                            WHERE tb_member.nama LIKE '%$search%'";
                            ...
                            $tb_transaksi = mysqli_query($koneksi, $query);
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php } ?>
                            ...
                            <td>
                      <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-pilih-paket<?php echo $d_tb_transaksi['id']; ?>"><i class="fas fa-edit"></i> Pilih </button>
                            </td>
                          </tr>
                        </table>
                      </td>
                      ...
                      <td>
                        <table>
                          <tr>
                            <td>
                        <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit<?php echo $d_tb_transaksi['id']; ?>"><i class="fas fa-edit"></i> Edit </button>
                            </td>
                          </tr>
                          <tr>
                            <td>
                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-hapus<?php echo $d_tb_transaksi['id']; ?>"><i class="fas fa-trash"></i> Delete </button>
                            </td>
                          </tr>
                          <tr>
                            <td>
                      ...
                      <?php } else { ?>
                        <?php
                        if ($d_tb_transaksi['dibayar'] == 'dibayar') { ?>
                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-batalkan<?php echo $d_tb_transaksi['id']; ?>"><i class="fas fa-times"></i> Batalkan Bayar </button>
                        <?php } else { ?>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <select name="id_paket" class="form-control" id="id_paket" required>
                          ...
                          ?>
                          <option value="<?= $d_tb_paket_d_d['id'] ?>" <?php selectPaket($d_tb_paket_d_d['id'], $d_tb_transaksi['id_paket']); ?>>
                <?= $d_tb_paket_d_d['nama_paket'] ?>
            </option>
                          <?php } ?>
                        </select>
                      </div>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_outlet" class="form-control" required>
                          ...
                          ?>
                          <option value="<?= $d_tb_outlet['id'] ?>" <?php selectOutlet($d_tb_outlet['id'], $d_tb_transaksi['id_outlet']); ?>>
                <?= $d_tb_outlet['nama'] ?>
            </option>
                          ...
                          <div class="form-group">
                            <label>Berat</label>
                            <input type="text" name="qty" value="<?php echo $d_tb_transaksi['qty']; ?>" class="form-control" placeholder="Masukkan Berat" oninput="validationInput(event)">
                          </div>
                  ...
                  <div class="modal fade" id="modal-tambah">
                    <div class="modal-dialog">
                      ...
                      <div class="form-group">
                            <label>Berat</label>
                            <input type="text" name="qty" class="form-control" placeholder="Masukkan Berat" oninput="validateInput(this)" required>
                          </div>

                          <div class="form-group">
                            <label>Biaya Tambahan</label>
                            <input type="text" name="biaya_tambahan" class="form-control" placeholder="Masukkan Biaya Tambahan" oninput="validateInput(this)" required>
                          </div>
